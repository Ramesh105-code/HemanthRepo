...
console.log(chalk.underline.rgb(255, 105, 180)("Underlined pink text!"));
console.log(chalk.italic.hex("#00CED1")("Italic text in DeepSkyBlue"));
console.log(chalk.strikethrough.rgb(128, 128, 128)("This text is strikethrough and gray"));
